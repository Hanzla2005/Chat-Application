    ...
    const searchContacts = async (searchTerm) => {
        try {
            if (searchTerm.length > 0) {
                ...
                console.log("API Response:", response.data.contacts); // ✅ Log full response

            } else {
                setSearchedContacts([]);
            }
        } catch (e) {
            console.log("API Route: ", SEARCH_CONTACTS_ROUTES);
            console.log("Searched Contacts: ", response.data.contacts);
            console.log(e);
        }
    }
