    ...
    const handleAttachmentChange = async (event) => {
        try {
            ...
            if (file) {
                ...
                formData.append("messageType", "file"); // ✅ Make sure messageType is added
                setIsUploading(true);
                ...
                if (response.status === 200 && response.data) {
                    ...
                    if(selectedChatType === "contact") {
                        socket.emit("sendMessage", {
                            ...
                            content: undefined,
                            recipient: selectedChatData._id,
                            messageType: "file", // Use the sent messageType
                            fileURL: response.data.fileURL, // ✅ Ensure this is correct
                        });
                    } else if(selectedChatType === "channel") {
                        socket.emit("send-channel-message",{
                            sender: userInfo.id,
    ...
    return (
        <div className='h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-6 gap-6'>
            ...
            <button
                ...
                className="bg-[#8417ff] rounded-md flex items-center justify-center p-5 focus:border-none hover:bg-[#741bda] focus:bg-[#741bda] outline-none focus:text-white duration-300 transition-all"
